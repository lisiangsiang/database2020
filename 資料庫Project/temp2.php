    ...
    <body>
        <div class="background">
            <div class="scene">
                <!--開啟筆記本後-->
                <div class="book">
                    <img id="notebook" src="image/notebook/notebook.png" class="notebookIcon makePointer "
                    ...
                    <div class="notebook" id="innerNotebook">
                        ...
                        <!--藍色標籤(切換景點頁)-->
                        <img src="image/notebook/bookmark_visit.png" id="bookmark_visit"
                            class="makePointer bookmark_visit" onclick="lable(bookmark_visit)">
                        <div id="title_attraction" class="title">
                            ・attraction
                        </div>
                        <!--紅色標籤(切換道具頁)-->
                        <img src="image/notebook/bookmark_item.png" id="bookmark_item" class="makePointer bookmark_item"
                            onclick="lable(bookmark_item)">
                        <div id="title_item" class="title">
                            ・item
                        </div>
                        <!--關閉筆記本-->
                        <img src="image/notebook/cancel.png" onclick="closeNotebook()" id="cancel"
                            class="makePointer cancel">
                    </div>
                </div>
            ...
            <div id=startpage class="startpage">
                ...
                <input type="button" id="startgame" value="開始遊戲"
                    style="position: relative; margin-left:-11%; margin-top: 60%;" onclick="signin()">
                <!---畫面剛開始 遊戲說明的按鈕-->
                <input type="button" id="explain" value="遊戲說明"
                    style="position: absolute; margin-left:-100%; margin-top: 80%;" onclick="open_explain()">
            </div>
            ...
            <div id="explainshow1" class="explain">
                <div class="explainbackground">
                    ...
                    <ol>
                        <input type="image" img src="image/notebook/next_page.png" id="next_page"
                            style="position: absolute;margin-left: 84%; margin-top: 25%;" onclick="nextpage2()">
                    </ol>
                    <ol>
                        <input type="button" id="return" value="結束說明"
                            style="position: absolute; margin-top: 40%; margin-left: 42%;" onclick="close_explain()">
                    </ol>
                </div>
            </div>
            ...
            <div id="explainshow2" class="explain">
                <div class="explainbackground">
                    ...
                    <ol>
                        <input type="image" img src="image/notebook/last_page.png"
                            style="position: absolute; margin-left: 12%; margin-top: 25%;" onclick="open_explain()">
                    </ol>
                    <ol>
                        <input type="image" img src="image/notebook/next_page.png"
                            style="position: absolute;; margin-left: 84%; margin-top: 25%;" onclick="nextpage3()">
                    </ol>
            ...
            <div id="explainshow3" class="explain">
                <div class="explainbackground">
                    ...
                    <ol>
                        <input type="image" img src="image/notebook/last_page.png"
                            style="position: absolute; margin-left: 12%; margin-top: 25%;" onclick="nextpage2()">
                    </ol>
            ...
            <div id="morning" class="morning">
                ...
                <div>
                    <!--要放記憶碎片的文字框-->
                    <input type="textarea" readonly="readonly" value="這裡放記憶碎片" class="textarea" onclick="intro()">
                </div>
            </div>
